    ...
    return (
        <div className="pt-24 pb-16 px-6 max-w-3xl mx-auto">
            ...
            <div className="space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 bg-card p-8 rounded-[2.5rem] border border-border shadow-xl">
                    {/* Image Upload Area */}
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            ...
                            <label className="aspect-square rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-all text-muted-foreground hover:text-primary">
                                ...
                                <span className="text-xs font-bold text-center px-2">{t("products.uploadImage")}</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm font-medium">{t("products.cropName")}</label>
                            <Input
                                required
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium">{t("products.location")}</label>
                            <Input
                                required
